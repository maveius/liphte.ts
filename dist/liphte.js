...
(function (liphte) {
    ...
    })(strategy = liphte.strategy || (liphte.strategy = {}));
})(liphte || (liphte = {}));
var liphte;
(function (liphte) {
    var strategy;
...
(function (liphte) {
    var html;
    (function (html) {
        var ExtractorContext = liphte.strategy.ExtractorContext;
    ...
    (function (strategy) {
        var ComplexAttributeRenderStrategy = (function (_super) {
            ...
            function ComplexAttributeRenderStrategy() {
                ...
                _this.selectFactory(liphte.factory.AttributeStrategyFactory);
                return _this;
            }
...
(function (liphte) {
    ...
    (function (factory) {
        ...
        var SimpleAttributeRenderStrategy = liphte.strategy.SimpleAttributeRenderStrategy;
        var ComplexAttributeRenderStrategy = liphte.strategy.ComplexAttributeRenderStrategy;
    ...
    })(factory = liphte.factory || (liphte.factory = {}));
})(liphte || (liphte = {}));
var liphte;
(function (liphte) {
    var html;
    (function (html) {
        var AttributeStrategyFactory = liphte.factory.AttributeStrategyFactory;
    ...
    (function (strategy) {
        var ComplexContentRenderStrategy = (function (_super) {
            ...
            function ComplexContentRenderStrategy() {
                var _this = _super.call(this) || this;
                _this.selectFactory(liphte.factory.ContentStrategyFactory);
                return _this;
            }
...
(function (liphte) {
    var factory;
    (function (factory) {
        var ComplexContentRenderStrategy = liphte.strategy.ComplexContentRenderStrategy;
        var SimpleContentRenderStrategy = liphte.strategy.SimpleContentRenderStrategy;
...
(function (liphte) {
    var html;
    (function (html) {
        var ContentStrategyFactory = liphte.factory.ContentStrategyFactory;
...
(function (liphte) {
    var factory;
    (function (factory) {
        var Attribute = liphte.html.Attribute;
...
(function (liphte) {
    ...
    (function (factory) {
        var TagUtils = utils.TagUtils;
        var Content = liphte.html.Content;
...
(function (liphte) {
    var builder;
    (function (builder) {
        var AttributeRenderableFactory = liphte.factory.AttributeRenderableFactory;
        var ContentRenderableFactory = liphte.factory.ContentRenderableFactory;
    ...
    })(builder = liphte.builder || (liphte.builder = {}));
})(liphte || (liphte = {}));
var liphte;
(function (liphte) {
    var builder;
...
(function (liphte) {
    var factory;
    (function (factory) {
        var SelfClosingTagBuilder = liphte.builder.SelfClosingTagBuilder;
        var PairedClosingTagBuilder = liphte.builder.PairedClosingTagBuilder;
...
var liphte;
(function (liphte) {
    var Mark = liphte.html.abstract.Markup;
    var TagBuilderFactory = liphte.factory.TagBuilderFactory;
